...
import kg.ivy.legacy.utils.shortenAmount
...
import kg.ivy.widgets.WidgetBase
...
class WalletBalanceWidgetReceiver : GlanceAppWidgetReceiver() {
    ...
    @Inject
    lateinit var ivyContext: kg.ivy.legacy.IvyWalletCtx
    ...
    private fun updateData(context: Context) {
        coroutineScope.launch {
            ...
            val appLocked = kg.ivy.legacy.utils.ioThread {
