...
import kg.ivy.frp.forward
import kg.ivy.frp.then2
import kg.ivy.home.Constants.SWIPE_HORIZONTAL_THRESHOLD
import kg.ivy.home.customerjourney.CustomerJourney
...
import kg.ivy.legacy.data.model.Month
import kg.ivy.legacy.data.model.TimePeriod
import kg.ivy.legacy.ivyWalletCtx
import kg.ivy.legacy.ui.component.transaction.TransactionsDividerLine
import kg.ivy.legacy.ui.component.transaction.transactions
import kg.ivy.legacy.utils.horizontalSwipeListener
import kg.ivy.legacy.utils.rememberSwipeListenerState
import kg.ivy.legacy.utils.verticalSwipeListener
...
import kg.ivy.wallet.ui.theme.modal.BufferModal
import kg.ivy.wallet.ui.theme.modal.BufferModalData
import kg.ivy.wallet.ui.theme.modal.ChoosePeriodModal
import kg.ivy.wallet.ui.theme.modal.ChoosePeriodModalData
import kg.ivy.wallet.ui.theme.modal.CurrencyModal
