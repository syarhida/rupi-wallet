...
sealed class ReportScreenEvent {
    ...
    data class SkipTransactionsLegacy(val transactions: List<kg.ivy.base.legacy.Transaction>) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class SkipTransactionLegacy(val transaction: kg.ivy.base.legacy.Transaction) :
        ReportScreenEvent()

    @Deprecated("Uses legacy Transaction")
    data class OnPayOrGetLegacy(val transaction: kg.ivy.base.legacy.Transaction) :
        ReportScreenEvent()
}
