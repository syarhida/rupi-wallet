...
import kg.ivy.legacy.utils.horizontalSwipeListener
import kg.ivy.legacy.utils.rememberSwipeListenerState
...
import kg.ivy.wallet.ui.theme.components.BalanceRowMini
import kg.ivy.wallet.ui.theme.components.CircleButtonFilledGradient
import kg.ivy.wallet.ui.theme.components.CloseButton
import kg.ivy.wallet.ui.theme.components.ItemIconM
...
import kg.ivy.wallet.ui.theme.gradientExpenses
import kg.ivy.wallet.ui.theme.modal.ChoosePeriodModal
import kg.ivy.wallet.ui.theme.pureBlur
import kg.ivy.wallet.ui.theme.toComposeColor
import kg.ivy.wallet.ui.theme.wallet.AmountCurrencyB1Row
...
private fun BoxWithConstraintsScope.UI(
    ...
    val percentExpanded by animateFloatAsState(
        ...
        animationSpec = kg.ivy.legacy.utils.springBounce(),
...
private fun Header(
    ...
    period: kg.ivy.legacy.data.model.TimePeriod,
            ...
            if (percentExpanded > 0f) {
                ...
                CircleButtonFilledGradient(
                    modifier = Modifier
                        ...
                        .alpha(percentExpanded)
                        .size(kg.ivy.legacy.utils.lerp(1, 40, percentExpanded).dp),
                    iconPadding = 4.dp,
...
private fun Preview_Expense() {
    kg.ivy.legacy.IvyWalletPreview {
        val state = PieChartStatisticState(
            ...
            period = kg.ivy.legacy.data.model.TimePeriod.currentMonth(
                startDayOfMonth = 1
            ), // preview
            baseCurrency = "BGN",
            totalAmount = 1828.0,
