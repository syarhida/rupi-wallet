        ...
        INVALID_DEFAULT_TEMPLATE(
            prDescription = """
                ...
                **In what cases won't your code work?**
                ...
                <!--💡 Tip: Replace {ISSUE_NUMBER} with the number of Rupi Wallet ISSUE (https://github.com/syarhida/rupi-wallet/issues)(❗NOT PR❗) which this pull request fixes. If done correctly, you'll see the issue title linked on PR preview. 💡-->
                <!--💡 Tip: Multiple issues:
